...
def main():
    ...
    controls={"requirement_exists":bool(requirements),"implementation_complete":implementation_complete,"dependencies_satisfied":dependencies_satisfied,"required_tests_exist":required_tests_exist,"required_tests_pass":tests_passed and required_tests_exist,"execution_exists":execution_exists,"evidence_exists":evidence_exists,"evidence_valid":False,"evidence_matches_source":False,"no_blocking_findings":False}
    findings=[]
    ...
    truth={"DEFINED":bool(requirements and tasks),"IMPLEMENTED":implementation_complete,"TESTED":controls["required_tests_pass"],"EXECUTED":False,"EVIDENCED":False,"VERIFIED":False,"CURRENT":False,"RELEASEABLE":False}
    batches=[]
